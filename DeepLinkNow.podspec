#
#  Be sure to run `pod spec lint DeeplinkNow.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                      DeepLinkNow is a powerful SDK for iOS that provides deep linking, 
                      deferred deep linking, and attribution tracking capabilities. 
  ...
  s.author           = { 'DeepLinkNow' => 'support@deeplink.now' }
  # Or just: s.author    = "JVG"
  # spec.authors            = { "JVG" => "2121331+jvgeee@users.noreply.github.com" }
  # spec.social_media_url   = "https://twitter.com/JVG"
  ...
  s.source_files = 'Sources/DeepLinkNow/**/*.swift'
  ...
  # Make sure the SDK is built as a framework
